      ...
      >
        <Container maxWidth="lg">
          ...
          >
            ...
            {/* Right Section - Form */}
            <Box sx={{ flex: { xs: "1 1 100%", md: 1 }, ml: { xs: 0, md: 4 } }}>
              <Typography
                variant="h2"
                fontWeight="bold"
                fontSize={{ xs: 28, sm: 32, md: 40 }}
                sx={{ color: "#253168ff", mb: 3, mt: { xs: 2, md: 4 } }}
              >
                IGNITE YOUR VISION
              </Typography>
